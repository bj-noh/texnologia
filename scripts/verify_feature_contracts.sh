...
require_pattern "TEXnologia/Editor/LaTeXEditorView.swift" "lineNumberGutterWidth: CGFloat = 88" "line number gutter width"
require_pattern "TEXnologia/Editor/LaTeXEditorView.swift" "textInset = NSSize(width: 36" "editor text separated from line number gutter"
require_pattern "TEXnologia/Editor/LaTeXEditorView.swift" "lineFragmentPadding: CGFloat = 4" "stable editor text left padding"
