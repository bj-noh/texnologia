...
require_pattern "TEXnologia/ProjectIndexing/ProjectSidebarView.swift" ".padding(.vertical, 4)" "compact explorer row padding"
...
require_pattern "TEXnologia/App/AppModel.swift" "fileSaveStates\\[selectedFileURL\\] = .saved" "opened editor file shows saved dot"
...
require_pattern "TEXnologia/Editor/LaTeXEditorView.swift" "lineNumberGutterWidth: CGFloat = 68" "compact line number gutter width"
require_pattern "TEXnologia/Editor/LaTeXEditorView.swift" "textInset = NSSize(width: 24" "compact editor text inset"
require_pattern "TEXnologia/Editor/LaTeXEditorView.swift" "lineFragmentPadding: CGFloat = 2" "compact editor text left padding"
