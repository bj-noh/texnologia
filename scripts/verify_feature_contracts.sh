...
require_pattern "TEXnologia/App/MainWindowView.swift" "HistoryDiffPopover" "history diff popover"
require_pattern "TEXnologia/History/HistoryDiff.swift" "HistoryDiffComputer" "history diff computer"
require_pattern "TEXnologia/History/HistoryDiff.swift" "newLines.difference(from: oldLines)" "line-level diff algorithm"
require_pattern "TEXnologia/History/HistoryDiffView.swift" "DiffHunksView" "github-style hunk view"
...
if grep -q 'ExplorerSectionHeader(title: "인용")' "$ROOT_DIR/TEXnologia/ProjectIndexing/ProjectSidebarView.swift"; then
  echo "FAIL explorer should not show citation clutter below outline" >&2
  exit 1
fi
...
require_pattern "TEXnologia/App/AppModel.swift" "fileSaveStates\\[url\\] = .saved" "opened editor file shows saved dot"
...
require_pattern "TEXnologia/App/MainWindowView.swift" "checkmark.circle.fill" "saved check indicator"
...
require_pattern "TEXnologia/ProjectIndexing/ProjectSidebarView.swift" "guard url.isDirectory else { return .saved }" "all explorer files show saved dot by default"
...
require_pattern "TEXnologia/Editor/LaTeXEditorView.swift" "static func gutterWidth" "adaptive line number gutter width"
...
require_pattern "TEXnologia/History/HistoryDiff.swift" "LatexDiffExporter" "DIF latex exporter"
require_pattern "TEXnologia/History/HistoryDiff.swift" "DIFaddbegin" "DIF addition marker"
require_pattern "TEXnologia/History/HistoryDiff.swift" "DIFdelbegin" "DIF deletion marker"
require_pattern "TEXnologia/History/HistoryDiffView.swift" "currentDIFLatex" "DIF export available in history popover"
require_pattern "TEXnologia/History/HistoryDiffView.swift" "Copy DIF LaTeX" "copy DIF menu item"
require_pattern "TEXnologia/History/HistoryDiffView.swift" "Save DIF LaTeX" "save DIF menu item"

require_pattern "TEXnologia/Editor/EditorActions.swift" "EditorTextOps" "editor shared text operations"
require_pattern "TEXnologia/Editor/EditorActions.swift" "editorToggleComment" "editor toggle comment notification"
require_pattern "TEXnologia/Editor/EditorActions.swift" "editorDuplicateLine" "editor duplicate line notification"
require_pattern "TEXnologia/Editor/EditorActions.swift" "editorDeleteLine" "editor delete line notification"
require_pattern "TEXnologia/Editor/EditorActions.swift" "editorMoveLineUp" "editor move line up notification"
require_pattern "TEXnologia/Editor/LaTeXEditorView.swift" "usesFindBar" "editor find bar enabled"
require_pattern "TEXnologia/Editor/LaTeXEditorView.swift" "isIncrementalSearchingEnabled" "incremental find enabled"
require_pattern "TEXnologia/App/TEXnologiaApp.swift" "Increase Font Size" "increase font size menu"
require_pattern "TEXnologia/App/TEXnologiaApp.swift" "Decrease Font Size" "decrease font size menu"
require_pattern "TEXnologia/App/TEXnologiaApp.swift" "Toggle Line Comment" "toggle comment menu"
require_pattern "TEXnologia/App/TEXnologiaApp.swift" "Duplicate Line" "duplicate line menu"
require_pattern "TEXnologia/App/TEXnologiaApp.swift" "Delete Line" "delete line menu"
require_pattern "TEXnologia/App/AppModel.swift" "adjustEditorFontSize" "font size adjustment action"
require_pattern "TEXnologia/App/AppModel.swift" "resetEditorFontSize" "font size reset action"

require_pattern "TEXnologia/Chat/ChatModels.swift" "LLMProvider" "LLM provider enum"
require_pattern "TEXnologia/Chat/ChatModels.swift" "LLMConfiguration" "LLM configuration model"
require_pattern "TEXnologia/Chat/LLMClient.swift" "AnthropicClient" "Anthropic client implementation"
require_pattern "TEXnologia/Chat/LLMClient.swift" "OpenAICompatibleClient" "OpenAI-compatible client implementation"
require_pattern "TEXnologia/Chat/ChatModels.swift" "case gemini" "Gemini provider"
require_pattern "TEXnologia/Chat/ChatModels.swift" "case xai" "xAI (Grok) provider"
require_pattern "TEXnologia/Chat/ChatModels.swift" "case deepseek" "DeepSeek provider"
require_pattern "TEXnologia/Chat/ChatModels.swift" "case mistral" "Mistral provider"
require_pattern "TEXnologia/Chat/ChatModels.swift" "case groq" "Groq provider"
require_pattern "TEXnologia/Chat/ChatModels.swift" "case ollama" "Ollama local provider"
require_pattern "TEXnologia/Chat/ChatModels.swift" "suggestedModels" "provider model suggestions"
require_pattern "TEXnologia/Chat/ChatModels.swift" "requiresAPIKey" "provider API-key requirement flag"
require_pattern "TEXnologia/Chat/ChatTools.swift" "ChatToolRegistry" "chat tool registry"
require_pattern "TEXnologia/Chat/ChatTools.swift" "list_project_files" "project list tool"
require_pattern "TEXnologia/Chat/ChatTools.swift" "read_project_file" "project read tool"
require_pattern "TEXnologia/Chat/ChatTools.swift" "write_project_file" "project write tool"
require_pattern "TEXnologia/Chat/ChatTools.swift" "replace_in_file" "project replace tool"
require_pattern "TEXnologia/Chat/ChatTools.swift" "apply_to_open_editor" "apply to open editor tool"
require_pattern "TEXnologia/Chat/ChatSession.swift" "runAgenticLoop" "agentic tool-use loop"
require_pattern "TEXnologia/Chat/ChatPaneView.swift" "ChatPaneView" "chat pane UI"
require_pattern "TEXnologia/Preferences/AppSettings.swift" "llm: LLMConfiguration" "LLM settings persisted"
require_pattern "TEXnologia/Preferences/PreferencesView.swift" "aiPane" "AI preferences tab"
require_pattern "TEXnologia/App/AppModel.swift" "isChatPaneVisible" "chat pane visibility state"
require_pattern "TEXnologia/App/AppModel.swift" "chatSession" "chat session owned by app model"
require_pattern "TEXnologia/App/MainWindowView.swift" "ChatPaneView" "chat pane rendered in main window"
require_pattern "TEXnologia/App/MainWindowView.swift" "AI Assistant" "AI toolbar button"

require_pattern "TEXnologia/App/SessionStateStore.swift" "SessionStateSnapshot" "session snapshot model"
require_pattern "TEXnologia/App/SessionStateStore.swift" "SessionStateStore" "session state store"
require_pattern "TEXnologia/App/SessionStateStore.swift" "session-state.json" "session state persisted to JSON"
require_pattern "TEXnologia/App/SessionStateStore.swift" "applicationSupportDirectory" "session state in Application Support"
require_pattern "TEXnologia/App/AppModel.swift" "openEditorTabsByWorkspace" "per-workspace open tabs"
require_pattern "TEXnologia/App/AppModel.swift" "dirtyEditorBuffers" "dirty buffer cache"
require_pattern "TEXnologia/App/AppModel.swift" "cleanDiskTextByURL" "clean disk baseline cache"
require_pattern "TEXnologia/App/AppModel.swift" "appendEditorTab" "append editor tab action"
require_pattern "TEXnologia/App/AppModel.swift" "activateEditorTab" "activate editor tab action"
require_pattern "TEXnologia/App/AppModel.swift" "closeEditorTab" "close editor tab action"
require_pattern "TEXnologia/App/AppModel.swift" "currentOpenEditorTabs" "current session tab list"
require_pattern "TEXnologia/App/AppModel.swift" "createEmptyProjectPanel" "empty project creation action"
require_pattern "TEXnologia/App/AppModel.swift" "persistSessionState" "session persistence entry point"
require_pattern "TEXnologia/App/AppModel.swift" "restoreSessionStateIfNeeded" "session restore on launch"
require_pattern "TEXnologia/App/AppModel.swift" "didRestoreSessionState" "restore guard flag"
require_pattern "TEXnologia/App/AppModel.swift" "willTerminateNotification" "persist on app quit"
require_pattern "TEXnologia/App/MainWindowView.swift" "EditorTabBar" "multi-file editor tab bar"
require_pattern "TEXnologia/App/MainWindowView.swift" "New Empty Project" "session + menu empty project item"
require_pattern "TEXnologia/App/MainWindowView.swift" "Open Folder or File" "session + menu open item"
require_pattern "TEXnologia/App/MainWindowView.swift" "Import Zip" "session + menu import item"
require_pattern "TEXnologia/App/MainWindowView.swift" "Merge to single preview pane" "preview merge icon tooltip"
